...
(function () {
  ...
  const I18N = {
    fa: {
      ...
      "hero.title": 'فروشگاه لباس زنانه<br><span class="grad">MAHO در کابل</span>',
     "hero.lead": "از لباس زنانه و چادر تا شال، کیف، کفش، بوت، چپلی، سرپایی، اکسسوری و لوازم آرایشی — هر آنچه یک خانم برای استایل خود نیاز دارد، با کیفیت ممتاز و قیمت مناسب در MAHO.",
